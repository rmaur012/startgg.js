...
//     // entrants
    ...
    it('should return null when winnerId given does not match either player entrant id', async () => {
        let set = new GGSet(1, null, null, {id: null}, null, null, {id: null}, null, null, [], null, null, null, {entrantId: 77} as IPlayerLite, {entrantId: 88} as IPlayerLite, 0, 3);
    ...
    xit('should report set and return sets with states', async () => {
        let set = new GGSet(66033074, null, null, {id: null}, null, null, {id: null}, null, null, [], null, null, null, {entrantId: 14494421} as IPlayerLite, {entrantId: 14494470} as IPlayerLite, 0, 3);
